...
func TestPing(t *testing.T) {
	...
	if rr.Body.String() != expected {
		t.Errorf("wrong return: got %v want %v",
...
func TestParamError(t *testing.T) {
	req, err := http.NewRequest("GET", "/api/posts?tags=tech,history&sortby=adf", nil)
	if err != nil {
		t.Fatal(err)
	}
	rr := httptest.NewRecorder()
...
func TestById(t *testing.T) {
	req, err := http.NewRequest("GET", "/api/posts?tags=tech,history", nil)
	if err != nil {
		t.Fatal(err)
	}
	rr := httptest.NewRecorder()
	handler := http.HandlerFunc(posts)
	handler.ServeHTTP(rr, req)
	if status := rr.Code; status != http.StatusOK {
		t.Errorf("wrong status code: got %v want %v",
			status, http.StatusOK)
	...
	// Check the response body is what we expect.
	expected := `[{"author":"Rylee Paul","authorId":9,"id":1,"likes":960,"popularity":0.13,"reads":50361,"tags":["tech","health"]},
	...
	{"author":"Trevon Rodriguez","authorId":5,"id":8,"likes":735,"popularity":0.76,"reads":8504,"tags":["culture","history"]},
	{"author":"Elisha Friedman","authorId":8,"id":10,"likes":853,"popularity":0.6,"reads":35913,"tags":["science","health","history"]},
	...
	{"author":"Lainey Ritter","authorId":1,"id":15,"likes":560,"popularity":0.8,"reads":81549,"tags":["culture","startups","tech"]},
	...
	{"author":"Tia Roberson","authorId":2,"id":39,"likes":307,"popularity":0.61,"reads":89454,"tags":["politics","history"]},
	...
	{"author":"Zackery Turner","authorId":12,"id":50,"likes":898,"popularity":0.96,"reads":4923,"tags":["health","history"]},
	{"author":"Jaden Bryant","authorId":3,"id":51,"likes":487,"popularity":0.01,"reads":98798,"tags":["design","startups","tech"]},
	{"author":"Bryson Bowers","authorId":6,"id":54,"likes":723,"popularity":0.56,"reads":312,"tags":["culture","tech"]},
	...
	{"author":"Tia Roberson","authorId":2,"id":64,"likes":163,"popularity":0.34,"reads":22095,"tags":["politics","history"]},
	{"author":"Trevon Rodriguez","authorId":5,"id":65,"likes":498,"popularity":0.87,"reads":85870,"tags":["history"]},
	{"author":"Trevon Rodriguez","authorId":5,"id":67,"likes":903,"popularity":0.71,"reads":26815,"tags":["health","history"]},
	...
	{"author":"Kinley Crosby","authorId":10,"id":79,"likes":617,"popularity":0.07,"reads":52494,"tags":["culture","startups","history"]},
	{"author":"Lainey Ritter","authorId":1,"id":80,"likes":874,"popularity":0.47,"reads":9002,"tags":["politics","history"]},
	{"author":"Bryson Bowers","authorId":6,"id":81,"likes":552,"popularity":0.09,"reads":22975,"tags":["design","history"]},
	...
	{"author":"Ahmad Dunn","authorId":7,"id":86,"likes":873,"popularity":0.91,"reads":53869,"tags":["startups","history"]},
	...
	{"author":"Tia Roberson","authorId":2,"id":99,"likes":473,"popularity":0.34,"reads":97868,"tags":["culture","startups","tech"]},
...
func TestIdDesc(t *testing.T) {
	req, err := http.NewRequest("GET", "/api/posts?tags=tech,history&direction=desc", nil)
	if err != nil {
		t.Fatal(err)
	}
	rr := httptest.NewRecorder()
	...
	// Check the response body is what we expect.
	expected := `[{"author":"Ahmad Dunn","authorId":7,"id":100,"likes":573,"popularity":0.43,"reads":89894,"tags":["science","design","history"]},
	{"author":"Tia Roberson","authorId":2,"id":99,"likes":473,"popularity":0.34,"reads":97868,"tags":["culture","startups","tech"]},
	{"author":"Lainey Ritter","authorId":1,"id":96,"likes":395,"popularity":0.44,"reads":99575,"tags":["science","history"]},
	{"author":"Jon Abbott","authorId":4,"id":95,"likes":985,"popularity":0.42,"reads":55875,"tags":["politics","tech","health","history"]},
	{"author":"Trevon Rodriguez","authorId":5,"id":93,"likes":881,"popularity":0.41,"reads":73964,"tags":["tech","history"]},
